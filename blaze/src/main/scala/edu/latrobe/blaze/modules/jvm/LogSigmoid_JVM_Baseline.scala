...
final class LogSigmoid_JVM_Baseline(override val builder:        LogSigmoidBuilder,
...
object LogSigmoid_JVM_Baseline_Description
  ...
  : LogSigmoid_JVM_Baseline = new LogSigmoid_JVM_Baseline(
