...
final class Exp_JVM_ApacheCommons(override val builder:        ExpBuilder,
...
object Exp_JVM_ApacheCommons_Description
  ...
  : Exp_JVM_ApacheCommons = new Exp_JVM_ApacheCommons(
