...
import edu.latrobe.blaze.modules.{LeakyReLU, LeakyReLUBuilder}

abstract class LeakyReLU_JVM
  extends LeakyReLU
    with MapLayer_JVM[LeakyReLUBuilder] {

  val alphaInv: Real = Real.one / alpha
