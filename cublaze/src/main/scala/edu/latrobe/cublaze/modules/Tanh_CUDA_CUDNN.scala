...
final class Tanh_CUDA_CUDNN(override val builder:        TanhBuilder,
  ...
  private val actDesc
  : _ActivationStruct = _ActivationStruct(CUDNN_ACTIVATION_TANH)
...
object Tanh_CUDA_CUDNN_Description
  extends ModuleVariant_CUDA_Description[TanhBuilder] {

  override def build(builder:        TanhBuilder,
                     hints:          BuildHints,
                     seed:           InstanceSeed,
                     weightsBuilder: ValueTensorBufferBuilder)
  : Tanh_CUDA_CUDNN = new Tanh_CUDA_CUDNN(
