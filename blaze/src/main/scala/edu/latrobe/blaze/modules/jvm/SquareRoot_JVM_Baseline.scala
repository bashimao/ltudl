...
final class SquareRoot_JVM_Baseline(override val builder:        SquareRootBuilder,
...
object SquareRoot_JVM_Baseline_Description
  ...
  : SquareRoot_JVM_Baseline = new SquareRoot_JVM_Baseline(
